...
This file provides guidance to any AI coding assistant (Claude Code, Gemini Code, etc.) working with code in this repository.
...
Run `ruff format` after every change you make
